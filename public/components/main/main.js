    ...
    return (
      ...
      <EuiPage>
        <EuiPageBody id="page-body">
          <EuiPageHeader>
            <EuiTitle size="l">
              <h1>Custom Dashboard<span class="author"> created by Will Cheng</span></h1>
            </EuiTitle>
          </EuiPageHeader>
          <EuiPageContent id="page-content">
            <EuiPageContentHeader>
              <EuiTitle>
                <h2 class="font-white">Congratulations</h2>
              </EuiTitle>
            </EuiPageContentHeader>
            <EuiPageContentBody>
            ...
            <EuiFlexItem>
              <EuiPanel grow={false} id="threeD-panel" style={{ maxWidth: 1200 }}>
